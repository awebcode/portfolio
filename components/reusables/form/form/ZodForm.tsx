...
type ZodHookFormProps<
  ...
  TIsFileUpload extends boolean = false
> = {
  ...
  onAcceptFiles?: TIsFileUpload extends true
    ? (acceptedFiles: FileWithPreview[]) => void
    : never;
};
  ...
  return (
    <FormProvider {...methods}>
      <form onSubmit={methods.handleSubmit(onSubmit)} className="w-full max-w-lg ">
        ...
        {isFileUpload && (
          <FilesUploadForm
            onAcceptFiles={onAcceptFiles as (acceptedFiles: FileWithPreview[]) => void}
          />
        )}
