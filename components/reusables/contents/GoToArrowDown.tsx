...
const GoToArrowDown: React.FC<GoToArrowDownProps> = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "inline cursor-pointer absolute bottom-4 left-1/2 py-3 px-2 ring-1 ring-primary rounded-full bg-white/80 text-primary hover:bg-primary hover:text-white ",
        className
      )}
      {...props}
    >
